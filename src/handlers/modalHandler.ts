...
export async function handleModals(interaction: ModalSubmitInteraction, client: StableHordeClient, database: Pool | undefined, stable_horde_manager: StableHorde) {
